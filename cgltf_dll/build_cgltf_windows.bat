...
:: Usage
:: > ridk enable
:: > build_cgltf_windows.bat  <- %PROGRAMFILES%\CMake\bin\cmake.exe will be used.
:: > build_cgltf_windows.bat "D:\Program Files\CMake\bin\cmake.exe" <- You can give full path to 'cmake.exe'.
